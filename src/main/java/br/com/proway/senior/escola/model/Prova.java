...
/**
 * A avaliacao do desempenho do Aluno em uma Materia.
 * 
 * A prova registra uma avaliacao realizada pelo {@link Aluno} relativo ao
 * conhecimento de uma materia. O {@link Aluno} poderah realizar varias
 * avaliacao da mesma materia. A media ponderada das notas das Provas serao
...
public class Prova {
	...
	/**
	 * avaliacao de desempenho do aluno
	 * 
	 * No construtor da prova não atribui-se valor para a nota para que seja
	 * possivel a criacao de provas para depois serem atribuidas as notas
	 * 
	...
	/**
	 * Determina a avaliacao do aluno.
	 * 
	 ...
	 * Peso da prova.
	 * 
	 * Este peso serah utilizado ao calcular a media ponderada das notas no 
	 * Boletim
	 * @return
	 */
	public int getPeso() {
